...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y9 [get_ports {GCK}];  # "GCLK"

# ----------------------------------------------------------------------------
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {OUTPUT[0]}];  # "JA1"
set_property PACKAGE_PIN AA11 [get_ports {OUTPUT[1]}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {OUTPUT[2]}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {OUTPUT[3]}];  # "JA4"
set_property PACKAGE_PIN AB11 [get_ports {OUTPUT[4]}];  # "JA7"
set_property PACKAGE_PIN AB10 [get_ports {OUTPUT[5]}];  # "JA8"
set_property PACKAGE_PIN AB9  [get_ports {OUTPUT[6]}];  # "JA9"
set_property PACKAGE_PIN AA8  [get_ports {OUTPUT[7]}];  # "JA10"
