...
--               C:/Users/benci/Documents/University/SEM4/SPROJ4/Software/Plotter_Driver_v2/Plotter_Driver_v2.srcs/sources_1/bd/Block_Design/ip/Block_Design_Plotter_Driver_v2_Top_0_1/Block_Design_Plotter_Driver_v2_Top_0_1_sim_netlist.vhdl
...
entity Block_Design_Plotter_Driver_v2_Top_0_1_Halfstepper is
  port (
  ...
  attribute ORIG_REF_NAME of Block_Design_Plotter_Driver_v2_Top_0_1_Halfstepper : entity is "Halfstepper";
end Block_Design_Plotter_Driver_v2_Top_0_1_Halfstepper;

architecture STRUCTURE of Block_Design_Plotter_Driver_v2_Top_0_1_Halfstepper is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Block_Design_Plotter_Driver_v2_Top_0_1_Halfstepper_0 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Block_Design_Plotter_Driver_v2_Top_0_1_Halfstepper_0 : entity is "Halfstepper";
end Block_Design_Plotter_Driver_v2_Top_0_1_Halfstepper_0;

architecture STRUCTURE of Block_Design_Plotter_Driver_v2_Top_0_1_Halfstepper_0 is
  ...
  attribute SOFT_HLUTNM of \current_addr[1]_i_1__0\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \current_addr[2]_i_1__0\ : label is "soft_lutpair3";
begin
  \GPIO_IN[4]\ <= \^gpio_in[4]\;
\Windings_sig[4]_i_1\: unisim.vcomponents.LUT3
    generic map(
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Block_Design_Plotter_Driver_v2_Top_0_1_Servo_PWM_Gen is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Block_Design_Plotter_Driver_v2_Top_0_1_Servo_PWM_Gen : entity is "Servo_PWM_Gen";
end Block_Design_Plotter_Driver_v2_Top_0_1_Servo_PWM_Gen;

architecture STRUCTURE of Block_Design_Plotter_Driver_v2_Top_0_1_Servo_PWM_Gen is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Block_Design_Plotter_Driver_v2_Top_0_1_Plotter_Driver_v2_Top is
  port (
    PWM_OUT : out STD_LOGIC;
    OUT_1 : out STD_LOGIC_VECTOR ( 3 downto 0 );
    OUT_2 : out STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Block_Design_Plotter_Driver_v2_Top_0_1_Plotter_Driver_v2_Top : entity is "Plotter_Driver_v2_Top";
end Block_Design_Plotter_Driver_v2_Top_0_1_Plotter_Driver_v2_Top;

architecture STRUCTURE of Block_Design_Plotter_Driver_v2_Top_0_1_Plotter_Driver_v2_Top is
  signal HALFSTEPPER_GEN_2_n_0 : STD_LOGIC;
begin
HALFSTEPPER_GEN_1: entity work.Block_Design_Plotter_Driver_v2_Top_0_1_Halfstepper
     port map (
      GCK => GCK,
...
HALFSTEPPER_GEN_2: entity work.Block_Design_Plotter_Driver_v2_Top_0_1_Halfstepper_0
     port map (
      GCK => GCK,
...
SERVO_PWM_GENERATOR: entity work.Block_Design_Plotter_Driver_v2_Top_0_1_Servo_PWM_Gen
     port map (
      GCK => GCK,
      GPIO_IN(0) => GPIO_IN(5),
      PWM_OUT => PWM_OUT
...
entity Block_Design_Plotter_Driver_v2_Top_0_1 is
  ...
  attribute NotValidForBitStream of Block_Design_Plotter_Driver_v2_Top_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of Block_Design_Plotter_Driver_v2_Top_0_1 : entity is "Block_Design_Plotter_Driver_v2_Top_0_1,Plotter_Driver_v2_Top,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of Block_Design_Plotter_Driver_v2_Top_0_1 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of Block_Design_Plotter_Driver_v2_Top_0_1 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of Block_Design_Plotter_Driver_v2_Top_0_1 : entity is "Plotter_Driver_v2_Top,Vivado 2019.1";
end Block_Design_Plotter_Driver_v2_Top_0_1;

architecture STRUCTURE of Block_Design_Plotter_Driver_v2_Top_0_1 is
...
begin
  ...
  OUT_2(3 downto 0) <= \^out_2\(3 downto 0);
U0: entity work.Block_Design_Plotter_Driver_v2_Top_0_1_Plotter_Driver_v2_Top
     port map (
      GCK => GCK,
