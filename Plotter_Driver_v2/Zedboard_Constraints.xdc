...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y9 [get_ports {GCK_0}];  # "GCLK"

# ----------------------------------------------------------------------------
# JA Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {OUT_1_0[7]}];  # "JA1"
set_property PACKAGE_PIN AA11 [get_ports {OUT_1_0[6]}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {OUT_1_0[5]}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {OUT_1_0[4]}];  # "JA4"
set_property PACKAGE_PIN AB11 [get_ports {OUT_1_0[3]}];  # "JA7"
set_property PACKAGE_PIN AB10 [get_ports {OUT_1_0[2]}];  # "JA8"
set_property PACKAGE_PIN AB9  [get_ports {OUT_1_0[1]}];  # "JA9"
set_property PACKAGE_PIN AA8  [get_ports {OUT_1_0[0]}];  # "JA10"


# ----------------------------------------------------------------------------
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W12 [get_ports {OUT_2_0[7]}];  # "JB1"
set_property PACKAGE_PIN W11 [get_ports {OUT_2_0[6]}];  # "JB2"
set_property PACKAGE_PIN V10 [get_ports {OUT_2_0[5]}];  # "JB3"
set_property PACKAGE_PIN W8 [get_ports {OUT_2_0[4]}];  # "JB4"
set_property PACKAGE_PIN V12 [get_ports {OUT_2_0[3]}];  # "JB7"
set_property PACKAGE_PIN W10 [get_ports {OUT_2_0[2]}];  # "JB8"
set_property PACKAGE_PIN V9 [get_ports {OUT_2_0[1]}];  # "JB9"
set_property PACKAGE_PIN V8 [get_ports {OUT_2_0[0]}];  # "JB10"

# ----------------------------------------------------------------------------
# JC Pmod - Bank 13
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN AB6 [get_ports {JC1_N}];  # "JC1_N"
set_property PACKAGE_PIN AB7 [get_ports {PWM_OUT_0}];  # "JC1_P"
set_property PACKAGE_PIN AA4 [get_ports {LIMIT_SWITCHES_0[1]}];  # "JC2_N"
set_property PACKAGE_PIN Y4  [get_ports {LIMIT_SWITCHES_0[0]}];  # "JC2_P"
...
#set_property IOSTANDARD LVCMOS33 [get_ports {gpio_rtl[1:0]}]