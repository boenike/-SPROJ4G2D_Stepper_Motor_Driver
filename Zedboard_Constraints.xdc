...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {OUTPUT[3]}];  # "JA1"
set_property PACKAGE_PIN AA11 [get_ports {OUTPUT[2]}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {OUTPUT[1]}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {OUTPUT[0]}];  # "JA4"
...
#set_property PACKAGE_PIN V22 [get_ports {D_Out}];  # "LD4"
#set_property PACKAGE_PIN W22 [get_ports {C_Out}];  # "LD5"
#set_property PACKAGE_PIN U19 [get_ports {B_Out}];  # "LD6"
#set_property PACKAGE_PIN U14 [get_ports {A_Out}];  # "LD7"
...
set_property PACKAGE_PIN N15 [get_ports {STP}];  # "BTNL"
...
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {DIR}];  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {EN}];  # "SW1"
